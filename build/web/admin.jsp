            ...
            <div class="container">
                <div class="row"><br>
                    <ul class="nav nav-tabs">
                        <li class="<c:if test="${not empty isFirst}">active</c:if>"><a href="#" class="b_tab_main">Main</a></li>
                        ...
                        <li><form action="users" method="POST"><input type="submit" role="presentation" class="btn btn-default b_tab_lots" value="Users"></form></li>
                    ...
                    <div id="tab_main" class="a_tabs <c:if test="${empty isFirst}">hidden</c:if>">
                        <h2>Main</h2>
                    ...
                    <div id="tab_users" class="a_tabs <c:if test="${empty users}">hidden</c:if>">
                        <h2>Users</h2>
                        ...
                        <table class="table table-striped"> 
                            <tbody>
                                ...
                                <%
                                    ...
                                    java.util.List<service.Person> persons = (java.util.List<service.Person>) request.getAttribute("persons");
                                

                                    for(int i = 0; i < persons.size(); i++){
                                %>
                                    <tr> 
                                        <td><%= persons.get(i).getId() %></td>
                                        <td><%= persons.get(i).getLastName() %></td>
                                        <td><%= persons.get(i).getMidName() %></td>
                                        <td><%= persons.get(i).getName() %></td>
                                        <td><%= persons.get(i).getAddress() %></td>
                                        <td><%= persons.get(i).getDocNumber() %></td>
                                        <td><%= persons.get(i).getOrg() %></td>
